...
fuel_t=int(sys.argv[5])
hei=float(sys.argv[6])
leng=float(sys.argv[6])   
wid=float(sys.argv[7])
doors=int(sys.argv[7])
powe=float(sys.argv[8])
tor=float(sys.argv[9])
seat_c = int(sys.argv[11])
wheel=float(sys.argv[10])
